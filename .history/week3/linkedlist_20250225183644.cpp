...
public:
    ...
    void insertAt(int index, int data)
    {
        ...
        // newNode akan ditambahkan stelah elemen terakhir dari panjang Node -1
        // contoh kita punya node 1 2 3 maka panjangnya akan 
        if (index == nodeLength  || index > nodeLength - 1)
        {
